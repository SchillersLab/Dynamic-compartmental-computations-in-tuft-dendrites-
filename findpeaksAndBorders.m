function [Ypk,Xpk,Wpk,Ppk, iLBh, iRBh] = findpeaksAndBorders(Yin,varargin)
...
if needWidth
  ...
  % (wxPk)
  [iPk,bPk,bxPk,byPk,wxPk, iLBh, iRBh] = findExtents(y,x,iPk,iFinite,iInfinite,iInflect,minP,minW,maxW,refW);
else
...
iPk = iPk(idx);
if needWidth
  [bPk, bxPk, byPk, wxPk, iLBh, iRBh] = fetchPeakExtents(idx,bPk,bxPk,byPk,wxPk, iLBh, iRBh);
end
...
%--------------------------------------------------------------------------
function [iPk,bPk,bxPk,byPk,wxPk, iLBh, iRBh] = findExtents(y,x,iPk,iFin,iInf,iInflect,minP,minW,maxW,refW)
...
[iPk,bPk,bxPk,byPk,wxPk, iLBh, iRBh] = removePeaksOutsideWidth(iPk,bPk,bxPk,byPk,wxPk,minW,maxW, iLBh, iRBh);
...
%--------------------------------------------------------------------------
function [iPk,bPk,bxPk,byPk,wxPk, iLBh, iRBh] = removePeaksOutsideWidth(iPk,bPk,bxPk,byPk,wxPk,minW,maxW, iLBh, iRBh)
...
%--------------------------------------------------------------------------
function [bPk,bxPk,byPk,wxPk, iLBh, iRBh] = fetchPeakExtents(idx,bPk,bxPk,byPk,wxPk, iLBh, iRBh)
bPk = bPk(idx);
bxPk = bxPk(idx,:);
byPk = byPk(idx,:);
wxPk = wxPk(idx,:);
